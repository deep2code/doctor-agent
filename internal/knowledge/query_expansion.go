...
var synonymGroups = [][]string{
	...
	{"肺炎", "肺部感染", "支气管肺炎"},
	{"支原体", "支原体肺炎"},
	{"鼻塞", "流鼻涕", "流涕", "鼻炎", "鼻窦炎", "鼻孔堵塞", "鼻子不通", "鼻孔不通"},
	{"嗓子疼", "咽喉痛", "咽痛", "嗓子痛", "喉咙痛", "喉咙疼", "嗓子干", "咽干", "嗓子痒", "喉咙痒"},
	{"扁桃体炎", "扁桃体", "扁桃体肥大", "腺样体肥大", "化脓性扁桃体炎", "扁桃体发炎", "扁桃体红肿"},
	{"咽炎", "咽喉炎", "喉咙发炎", "嗓子发炎", "咽部发炎", "咽喉红肿", "咽部红肿"},
	{"喉炎", "急性喉炎", "喉咙炎症", "声带炎", "声音嘶哑"},
	{"中耳炎", "耳朵发炎", "耳朵疼", "抓耳朵", "耳痛", "耳朵痛"},
	{"腮腺炎", "痄腮", "蛤蟆瘟"},

	// --- 消化 ---
	{"拉肚子", "拉稀", "腹泻", "大便稀", "水样便", "蛋花汤样大便", "大便稀薄", "拉稀水"},
	{"便秘", "排便困难", "不拉大便", "攒肚", "大便干", "大便硬", "排便不畅"},
	{"肚子疼", "腹痛", "肚子痛", "胃痛", "胃疼", "肚子不舒服", "肚子绞痛", "肚脐周围疼", "小腹痛"},
	{"腹胀", "胀气", "肚子胀", "放屁多", "放屁", "屁多", "屁臭", "排气多", "肚子鼓"},
	{"恶心", "反胃", "想吐", "犯恶心", "恶心想吐"},
	{"呕吐", "吐奶", "溢奶", "喷奶", "吐", "吃完奶就吐", "奶从嘴里流出来"},
	{"便血", "大便带血", "血便", "黑便", "果酱样大便", "大便有血"},
	{"反酸", "烧心", "胃酸", "酸水", "嘴里酸"},
	{"没胃口", "食欲不振", "食欲差", "不想吃饭", "吃不下"},
	{"乳糖不耐受", "乳糖酶缺乏", "喝奶就拉肚子"},
	{"蛋白过敏", "牛奶蛋白过敏", "奶粉过敏"},
	{"轮状病毒", "秋季腹泻"},
	{"诺如病毒", "诺如"},
	{"蛔虫", "寄生虫", "肚子里有虫", "蛲虫", "挠屁股"},
	{"疝气", "腹股沟疝", "小肠串气", "脐疝", "肚脐突出", "疝"},
	{"肠套叠", "阵发性哭闹"},
	{"肛裂", "肛门裂", "排便哭闹出血"},

	// --- 泌尿 ---
	{"尿频", "排尿频繁", "尿多", "尿量多", "尿不多", "尿少", "次数多", "频繁上厕所"},
	{"尿痛", "尿尿疼", "排尿疼", "小便疼", "尿尿痛", "尿路疼", "小便痛", "尿时疼", "尿的时候痛"},
	{"尿路感染", "尿道炎", "膀胱炎", "尿路炎", "泌尿系感染", "泌尿系统感染"},
