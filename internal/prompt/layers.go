...
5. **"专业描述"小节必须存在**：无论输出哪个版本，在"参考文献"（或回答末尾）之前必须有"## 专业描述"小节，供有医学背景的用户深入学习；通俗版里它放在最后，用相对专业但不冗长的篇幅。`
